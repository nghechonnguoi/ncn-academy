...

{
  ...
  "PILLAR_3_DESC": "Mô tả chi tiết (dài ~70 chữ)."
    ...
    const fullData = {
      ...
      TOP1_KIENTHUC: aiTexts.CAREER_1_KIENTHUC || '',
      TOP1_KYNANG:   aiTexts.CAREER_1_KYNANG   || '',
      TOP1_LOTRINH:  aiTexts.CAREER_1_LOTRINH  || '',
      TOP1_VIECLEM:  aiTexts.CAREER_1_VIECLEM  || '',
      TOP1_ADVICE:   aiTexts.CAREER_1_ADVICE   || '',
      TOP2_KIENTHUC: aiTexts.CAREER_2_KIENTHUC || '',
      TOP2_KYNANG:   aiTexts.CAREER_2_KYNANG   || '',
      TOP2_LOTRINH:  aiTexts.CAREER_2_LOTRINH  || '',
      TOP2_VIECLEM:  aiTexts.CAREER_2_VIECLEM  || '',
      TOP2_ADVICE:   aiTexts.CAREER_2_ADVICE   || '',
      TOP3_KIENTHUC: aiTexts.CAREER_3_KIENTHUC || '',
      TOP3_KYNANG:   aiTexts.CAREER_3_KYNANG   || '',
      TOP3_LOTRINH:  aiTexts.CAREER_3_LOTRINH  || '',
      TOP3_VIECLEM:  aiTexts.CAREER_3_VIECLEM  || '',
      TOP3_ADVICE:   aiTexts.CAREER_3_ADVICE   || '',
      TOP4_KIENTHUC: aiTexts.CAREER_4_KIENTHUC || '',
      TOP4_KYNANG:   aiTexts.CAREER_4_KYNANG   || '',
      TOP4_LOTRINH:  aiTexts.CAREER_4_LOTRINH  || '',
      TOP4_VIECLEM:  aiTexts.CAREER_4_VIECLEM  || '',
      TOP4_ADVICE:   aiTexts.CAREER_4_ADVICE   || '',
      TOP5_KIENTHUC: aiTexts.CAREER_5_KIENTHUC || '',
      TOP5_KYNANG:   aiTexts.CAREER_5_KYNANG   || '',
      TOP5_LOTRINH:  aiTexts.CAREER_5_LOTRINH  || '',
      TOP5_VIECLEM:  aiTexts.CAREER_5_VIECLEM  || '',
      TOP5_ADVICE:   aiTexts.CAREER_5_ADVICE   || '',
